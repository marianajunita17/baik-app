<?php namespace App\Http\Controllers;
	...
	class AdminAnaksController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Pasien Id","name"=>"pasien_id","join"=>"pasiens,nama_pasien"];
			...
			$this->form[] = ['label'=>'Tanggal Lahir','name'=>'tgl_lahir','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
