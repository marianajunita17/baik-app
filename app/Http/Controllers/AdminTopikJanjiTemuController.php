<?php namespace App\Http\Controllers;
	...
	class AdminTopikJanjiTemuController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->col[] = ["label"=>"Nama Topik","name"=>"topiks_id","join"=>"topiks,nama_topik"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Topik Id","name"=>"topik_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"topik,id"];
