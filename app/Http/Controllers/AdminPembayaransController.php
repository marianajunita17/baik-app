<?php namespace App\Http\Controllers;
	...
	class AdminPembayaransController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Konselor Janji Temu","name"=>"janji_temu_konselor_id","join"=>"janji_temu,konselor_id"];
