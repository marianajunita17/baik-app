<?php namespace App\Http\Controllers;
	...
	class AdminSpesialisasisController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "nama_spesialisasi";
			$this->limit = "20";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Nama Spesialisasi","name"=>"nama_spesialisasi","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Bidang Id","name"=>"bidang_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"bidang,id"];
			# OLD END FORM
