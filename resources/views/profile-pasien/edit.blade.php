                    ...
                    <div class="class-details">
                        ...
                        <div class="vs-register-form">
                            <div class="form-title">
                                <h3 class="blog-inner-title">Edit Profile</h3>
                            </div>
                            <form method="POST" action="{{ route('profile.update') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <input type="text" value="{{ $users->nama_pasien }}"
                                            placeholder="Nama Pasien" name="nama_pasien" id="nama_pasien"
                                            class="form-control style2">
                                        <i class="fal fa-user"></i>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <input type="email" value="{{ $users->email }}" placeholder="Email"
                                            name="email" id="email" class="form-control style2">
                                        <i class="fal fa-envelope"></i>
                                    </div>
                                    <div class="col-md-6 form-group">

                                        <input type="number" placeholder="Umur" name="umur" id="umur"
                                            class="form-control style2" value="{{ $users->umur }}">
                                        <i class="fal fa-envelope"></i>
                                    </div>
                                    ...
                                    <div class="col-12 form-group">
                                        <button type="submit" class="vs-btn"><i
                                                class="fal fa-paper-plane"></i>Simpan Profile</button>
                                    </div>
                                </div>
                        </div>
                    </div> <!-- / class details -->
