...
<body>
            ...
            <div class="row gx-60 gy-30 flex-column-reverse flex-lg-row align-items-center">
                    ...
                    <form action="mail.php" method="POST" class="appointment-form ajax-contact">
                        <div class="row gx-15">
                            <div class="form-group col-sm-6">
                                <input type="text" class="form-control" name="parent-name" id="gurdian-name" placeholder="Parent Name">
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <input type="radio" class="form-control" name="child-age" id="child-age" placeholder="Gender of Child">
                            </div>
                            <div class="form-group col-12">
                                <textarea class="form-control" name="message" id="message" placeholder="Message"></textarea>
                            </div>
                            <div class="form-group col-12">
                                <a href="home" class="vs-btn wave-btn">Login</a>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-lg-5 wow fadeInRight" data-wow-delay="0.1s">
                    <div class="text-center text-lg-start">
                        ...
                        <p class="fs-md mb-30">Dokter Psikolog terbaik dengan harga yang terjangkau, tentunya kami akan memberikan fitur yang menarik dan juga kualitas yang terbaik!</p>
                        <a href="profil-baik" class="vs-btn wave-btn style-1">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="shape-mockup z-index-3 d-none d-hd-block" data-bottom="-8%" data-right="0%"><img src="{{ asset('assets//img/shape/rainbow-star.png') }}" alt="shapes"></div>

        <div class="shape-mockup moving d-none d-hd-block" data-top="22%" data-left="7%"><img src="{{ asset('assets//img/icon/note.png') }}" alt="shapes"></div>
        <div class="shape-mockup shapePulse d-none d-hd-block" data-bottom="20%" data-left="7%"><img src="{{ asset('assets//img/icon/bird.png') }}" alt="shapes"></div>
    </section>
    <!--======== / Appointment Section ========-->
    ...
    {{-- <section class="team-section bg-smoke space-top space-extra-bottom">
        ...
        <div class="shape-mockup movingX d-none d-sm-block" data-top="18%" data-left="12%"><img src="{{ asset('assets//img/icon/car-2.png') }}" alt="shapes"></div>
        <div class="shape-mockup shapePulse d-none d-hd-block" data-bottom="20%" data-left="5%"><img src="{{ asset('assets//img/icon/sun.png') }}" alt="shapes"></div>
        <div class="shape-mockup moving d-none d-hd-block" data-bottom="10%" data-right="4%"><img src="{{ asset('assets//img/icon/math-1.png') }}" alt="shapes"></div>
    </section>
    <!--======== / Team Section ========-->
    ...
    <section class="cta-section bg-smoke-blue space">
        ...
        <div class="section-after style-2"><img src="{{ asset('assets//img/shape/main-shape-after.png') }}" alt="shape"></div>
        <div class="shape-mockup d-none d-hd-block" data-top="0%" data-left="0%"><img src="{{ asset('assets//img/icon/rainbow-cloud.png') }}" alt="shapes"></div>
        <div class="shape-mockup shapePulse d-none d-hd-block" data-top="40%" data-right="14%"><img src="{{ asset('assets//img/icon/butterfly-4.png') }}" alt="shapes"></div>
    </section>
    <!--======== / CTA Section ========-->
    ...
    <section class="blog-section space-top space-extra-bottom">
            ...
            <div class="row vs-carousel" data-slide-show="3" data-arrows="true">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="vs-blog blog-card">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog-details.html"><i class="fal fa-calendar-alt"></i>10 October, 2023</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="vs-blog blog-card">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog-details.html"><i class="fal fa-calendar-alt"></i>12 November, 2023</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="vs-blog blog-card">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog-details.html"><i class="fal fa-calendar-alt"></i>01 December, 2023</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="vs-blog blog-card">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog-details.html"><i class="fal fa-calendar-alt"></i>03 October, 2023</a>
        ...
        <div class="shape-mockup shapePulse d-none d-md-block" data-top="22%" data-left="8%"><img src="{{ asset('assets//img/icon/apple.png') }}" alt="shapes"></div>
        <div class="shape-mockup moving d-none d-hd-block" data-bottom="22%" data-left="4%"><img src="{{ asset('assets//img/icon/ruler.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX d-none d-xl-block" data-top="17%" data-right="6%"><img src="{{ asset('assets//img/icon/cloud-3.png') }}" alt="shapes"></div>
        <div class="shape-mockup rotate d-none d-hd-block" data-bottom="24%" data-right="6%"><img src="{{ asset('assets//img/icon/math-2.png') }}" alt="shapes"></div>
    </section>
    <!--======== / Blog Section ========-->
	...
	Footer Area
	==============================-->
    <footer class="footer-wrapper footer-layout3" data-bg-src="{{ asset('assets//img/bg/footer-4.jpg') }}">
        ...
        <div class="shape-mockup movingX d-none d-hd-block" data-top="7%" data-left="5%"><img src="{{ asset('assets//img/icon/f-i-3-1.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX-reverse d-none d-hd-block" data-top="62%" data-left="10%"><img src="{{ asset('assets//img/icon/f-i-3-2.png') }}" alt="shapes"></div>
        <div class="shape-mockup rotate d-none d-hd-block" data-top="69%" data-left="32%"><img src="{{ asset('assets//img/icon/f-i-3-3.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX d-none d-hd-block" data-top="3%" data-left="46%"><img src="{{ asset('assets//img/icon/f-i-3-4.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX-reverse d-none d-hd-block" data-top="18%" data-right="3%"><img src="{{ asset('assets//img/icon/f-i-3-5.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX d-none d-hd-block" data-top="62%" data-right="6%"><img src="{{ asset('assets//img/icon/f-i-3-6.png') }}" alt="shapes"></div>
    </footer>


    <footer class="footer-wrapper footer-layout1 d-none" data-bg-src="{{ asset('assets//img/bg/footer-3.png') }}">
        <div class="widget-area">
            <div class="container">
                <div class="row justify-content-between">
                    <!-- About Widget-->
        ...
        <div class="shape-mockup movingX d-none d-hd-block" data-top="7%" data-left="5%"><img src="{{ asset('assets//img/icon/sun-3.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX d-none d-hd-block" data-bottom="56%" data-left="33%"><img src="{{ asset('assets//img/icon/butterfly.png') }}" alt="shapes"></div>
        <div class="shape-mockup moving d-none d-hd-block" data-top="49%" data-right="30%"><img src="{{ asset('assets//img/icon/butterfly-sm.png') }}" alt="shapes"></div>
        <div class="footer-copyright">
            <div class="container">
