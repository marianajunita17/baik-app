...
<head>
    ...
    <title>Status Booking - BAIK</title>
...
<body>
    ...
    <!--======== Wishlist Section ========-->
    <div class="wishlist-area space-page">
        <div class="container">
                        ...
                        <tbody>
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/product/p-thumb-1.jpg') }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.html">Revive Shampoo</a>
                                </td>
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/product/p-thumb-2.jpg') }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.html">Water Bottle</a>
                                </td>
                                <td class="product-price">
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/product/p-thumb-3.jpg') }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.html">Pure Honey</a>
                                </td>
                                <td class="product-price">
                                    <ins><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>18.00</bdi></span></ins>
                                    <del><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>20.00</bdi></span></del>
