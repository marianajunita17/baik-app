...
<body>
    ...
    <section class="about-section space">
        ...
        <div class="shape-mockup shapePulse d-none d-hd-block" data-bottom="40%" data-left="6%"><img src="{{ asset('assets/img/icon/dog.png') }}" alt="shapes"></div>
        <div class="shape-mockup rotate d-none d-md-block" data-bottom="40%" data-right="6%"><img src="{{ asset('assets/img/icon/star.png') }}" alt="shapes"></div>
    </section>
    <!--======== / About Section ========-->
    ...
    <section class="counter-section space-double" data-bg-src="{{ asset('assets/img/bg/counter.jpg') }}" data-overlay="title" data-opacity="8">
        ...
        <div class="section-before style-2"><img src="{{ asset('assets/img/shape/counter-before-1.png') }}" alt="shape"></div>
        <div class="section-after style-2"><img src="{{ asset('assets/img/shape/counter-after-1.png') }}" alt="shape"></div>
                ...
                <div class="row gy-60 justify-content-between">
                    ...
                    <div class="col-auto process-box wow fadeInUp" data-wow-delay="0.1s">
                        <div class="process-box-body">
                            ...
                            <div class="process-content">
                                ...
                                <h5 class="process-name"><a href="contact.html">Appointment With Us</a></h5>
                            </div>
                        </div>
                    </div>
                    <!-- Single Item -->
                    <div class="col-auto process-box wow fadeInUp" data-wow-delay="0.1s">
                        <div class="process-box-body">
                            ...
                            <div class="process-content">
                                <div class="process-icon">
                                    <img src="{{ asset('assets/img/icon/process2-3.png') }}" alt="icon">
                                </div>
                                <h5 class="process-name"><a href="classes.html">Start Learning Your Kids</a></h5>
                            </div>
                        </div>
                    </div>
                    <!-- Single Item -->
                    <div class="col-auto process-box wow fadeInUp" data-wow-delay="0.1s">
                        <div class="process-box-body">
                            ...
                            <div class="process-content">
                                <div class="process-icon">
                                    <img src="{{ asset('assets/img/icon/process2-4.png') }}" alt="icon">
                                </div>
                                <h5 class="process-name"><a href="classes.html">Get The Establish Kids</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="process-line"><img src="{{ asset('assets/img/shape/dashed-line-1.png') }}" alt="shape"></div>
            </div>
        </div>
    </section>
    <!--======== / Process Section ========-->
    ...
    <section class="team-section bg-smoke space-extra-top space-bottom-shape-min">
        ...
        <div class="shape-before"><img src="{{ asset('assets/img/shape/before-shape-5.png') }}" alt="shape"></div>
        <div class="shape-after"><img src="{{ asset('assets/img/shape/after-shape-5.png') }}" alt="shape"></div>

        <div class="shape-mockup movingX d-none d-hd-block" data-top="12%" data-left="6%"><img src="{{ asset('assets/img/icon/doll-1.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX d-none d-hd-block" data-bottom="9%" data-left="5%"><img src="{{ asset('assets/img/icon/shoe-1.png') }}" alt="shapes"></div>
        <div class="shape-mockup shapePulse d-none d-hd-block" data-top="12%" data-right="5%"><img src="{{ asset('assets/img/icon/dog-2.png') }}" alt="shapes"></div>
        <div class="shape-mockup movingX d-none d-hd-block" data-bottom="12%" data-right="3%"><img src="{{ asset('assets/img/icon/plane-1.png') }}" alt="shapes"></div>
    </section>
    <!--======== / Team Section ========-->
                    ...
                    <div class="testi-slider-area">
                        <div class="row testi-slider vs-carousel" id="testi1" data-slide-show="2">
                            ...
                            <div class="col-md-6">
                                <div class="testi-box">
                                    <div class="testi-avater">
                                        <img src="{{ asset('assets/img/testimonial/avator-2.jpg') }}" alt="testimonial">
                                        <i class="fa-solid fa-quote-left"></i>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="testi-box">
                                    <div class="testi-avater">
                                        <img src="{{ asset('assets/img/testimonial/avator-3.jpg') }}" alt="testimonial">
                                        <i class="fa-solid fa-quote-left"></i>
                                    </div>
